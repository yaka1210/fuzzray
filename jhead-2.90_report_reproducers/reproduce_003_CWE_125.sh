#!/usr/bin/env bash
# FuzzRay reproducer — crash 3
# CWE: CWE-125 (CWE-125)
# Severity: MEDIUM
# Location: __sanitizer::Abort

set -u

TARGET='jhead-2.90/jhead'
CRASH='jhead-2.90/out/default/crashes/id_000028,sig_06,src_000009,time_286189,execs_24532,op_quick,pos_5801,val_+1'
...
echo "[FuzzRay] Reproducing crash 3 (CWE-125)..."
