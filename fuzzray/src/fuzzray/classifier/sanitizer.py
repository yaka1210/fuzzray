...
_RULES: list[tuple[re.Pattern[str], str, float]] = [
    ...
    (re.compile(r"SEGV on unknown address.{0,400}caused by.{0,30}WRITE.{0,800}in\s+(?:free|__interceptor_free\b|__asan::Allocator::Deallocate)", re.I | re.S), "CWE-415", 0.88),
